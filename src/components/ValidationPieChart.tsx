    ...
    >
      ...
      <div className="mt-8 grid grid-cols-2 gap-4">
        <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
          <p className="text-xs font-bold text-emerald-600 uppercase tracking-wider mb-1">Acierto (TP)</p>
          <p className="text-2xl font-black text-emerald-700">{((tp / total) * 100).toFixed(1)}%</p>
          <p className="text-[10px] text-emerald-500 mt-1">Modelo clasificó correctamente</p>
        </div>
        <div className="p-4 bg-red-50 rounded-2xl border border-red-100">
          <p className="text-xs font-bold text-red-600 uppercase tracking-wider mb-1">Error (FP)</p>
          <p className="text-2xl font-black text-red-700">{((fp / total) * 100).toFixed(1)}%</p>
